...
class XaresAICoder {
                ...
                <div class="project-info">
                    <h4>
                        ...
                        ${project.useProxy ? `<button class="ai-conv-btn" onclick="app.openAIConversationsModal('${project.projectId}')" title="View AI Conversations" aria-label="AI Conversations">
                            <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
                                <path d="M2.678 11.894a1 1 0 0 1 .287.801 10.97 10.97 0 0 1-.398 2c1.395-.323 2.247-.697 2.634-.893a1 1 0 0 1 .71-.074A8.06 8.06 0 0 0 8 14c3.996 0 7-2.807 7-6 0-3.192-3.004-6-7-6S1 4.808 1 8c0 1.468.617 2.83 1.678 3.894zm-.493 3.905a21.682 21.682 0 0 1-.713.129c-.2.032-.352-.176-.273-.362.354-.836.674-1.95.77-2.966C.744 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.52.263-1.639.742-3.468 1.105z"/>
                            </svg>
                        </button>` : ''}
    ...
    getDiskUsageLabel(diskUsage) {
        // Don't show disk usage if disabled in config
        if (!this.config || !this.config.showDiskUsage) {
            return null;
        }
